...
<div class="row height-head m-0 pt-40">
    <div class="col-md-3">
        <ul class="leftSidePublish">
            <li class="selected"><span class="numberCircle">1</span> {{__('information')}}</li>
            <li><span  class="numberCircle">2</span> {{__('information detailed')}}</li>
            <li><span class="numberCircle">3</span> {{__('payment')}}</li>
        </ul>
    </div>
        ...
        <div class="panel-body">
            ...
            <div>
                <fieldset>
                    ...
                    <div class="form-group col-md-6 {!! $errors->has('fk_type_of_property') ? 'has-error' : '' !!}">
